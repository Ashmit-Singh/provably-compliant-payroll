...
describe('ErrorBoundary', () => {
  beforeEach(() => {
    // Suppress console.error for this test since we're testing error boundaries
  ...
  it('shows retry button and calls retry function', () => {
    render(
      <ErrorBoundary>
        <ThrowError shouldThrow={true} />
      </ErrorBoundary>
  ...
  it('shows go home button and navigates to home', () => {
